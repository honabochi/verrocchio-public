...
| Audited product candidate | `d381287` | 2026-08-30 JST | Tested endpoint for the implementation evidence below |
...
This range contains 32 commits. Against the July baseline, it changes 48 files
with 9,307 insertions and 1,036 deletions. The final metadata-only documentation
...
```bash
git diff --stat 3be515d..d381287
git log --format='%h %aI %s' f12214b^..d381287
```
...
## Verification status at `d381287`
