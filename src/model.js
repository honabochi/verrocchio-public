...
const legacyJapaneseText = new Map([
  ...
  ["Stage one is pass/fail for theme fit and meaningful WebMCP use. Stage two judges WebMCP Leverage, Execution, Potential Impact, and Creativity & Ambition; the official readback does not establish equal weighting.", "第1段階はテーマ適合と実質的なWebMCP利用の合否判定。第2段階はWebMCP Leverage、Execution、Potential Impact、Creativity & Ambitionの4項目で評価する。公式readbackで比重は確認できていない。"],
